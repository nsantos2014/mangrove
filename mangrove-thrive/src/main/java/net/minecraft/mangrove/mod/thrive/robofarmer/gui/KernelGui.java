package net.minecraft.mangrove.mod.thrive.robofarmer.gui;
...
public class KernelGui extends MGGui{
...
//    private static final ResourceLocation craftingTableGuiTextures2 = new ResourceLocation("textures/gui/container/driller.png");
    ...
    private TileFarmerKernel crate;
    ...
    private KernelGui(KernelContainer container, TileFarmerKernel autobench){
...
//    }
    public KernelGui(InventoryPlayer par1InventoryPlayer, TileFarmerKernel autobench){
    	this(new KernelContainer(autobench,par1InventoryPlayer),autobench);
    }
    @Override
    public void initGui() {
    	super.initGui();
