...
public class GuiFeeder extends MGGui{
...
//    private static final ResourceLocation craftingTableGuiTextures2 = new ResourceLocation("textures/gui/container/driller.png");
    ...
    private TileEntityFeeder crate;
	
	private GuiButton nextPageButton;
	private GuiButton prevPageButton;
	
	private ContainerFeeder container;

    private GuiFeeder(ContainerFeeder container, TileEntityFeeder autobench){
...
//    }
    public GuiFeeder(InventoryPlayer par1InventoryPlayer, TileEntityFeeder autobench){
    	this(new ContainerFeeder(autobench,par1InventoryPlayer),autobench);
    }
    @Override
    public void initGui() {
    	super.initGui();
