...
public class BlockRobotLinkRenderer implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderBlockFence(BlockLink block, int x, int y, int z, RenderBlocks renderer, IBlockAccess world) {
...
//        renderer.setOverrideBlockTexture(icon);
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
        ...
        return renderBlockFence((BlockLink) block, x, y, z, renderer, world);
    }
