...
public class TESRLink extends TileEntitySpecialRenderer {
	...
	public void renderKnot(TileEntityLink tile, double x, double y, double z, float u, int v) {
...
//			}
		...
		{ // draw connetors
			...
			for(EnumFacing facing:EnumFacing.values()){
				...
				if( block==blockType && blockState.getValue(BlockLink.NETWORK_ID)==sideBlockState.getValue(BlockLink.NETWORK_ID)){
...
//		tessellator.draw();
	...
	public void renderBeacon(TileEntityLink p_180536_1_, double p_180536_2_, double p_180536_4_, double p_180536_6_, float p_180536_8_, int p_180536_9_) {
		float f1 = 1;
		GlStateManager.alphaFunc(516, 0.1F);
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float p_180535_8_, int p_180535_9_) {
		this.renderKnot((TileEntityLink) te, x, y, z, p_180535_8_, p_180535_9_);
