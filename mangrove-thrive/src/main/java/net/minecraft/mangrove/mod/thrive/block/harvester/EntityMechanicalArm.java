...
public class EntityMechanicalArm extends Entity {
	...
	protected TileEntityHarvester parent;
	...
	public EntityMechanicalArm(World world, double x, double y, double z, double width, double height, TileEntityHarvester parent) {
		this(world);
