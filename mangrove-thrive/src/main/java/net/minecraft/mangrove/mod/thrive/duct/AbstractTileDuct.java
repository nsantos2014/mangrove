...
public abstract class AbstractTileDuct extends TileEntityLockable implements IHopper, IUpdatePlayerListBox {
	private ItemStack[] inventory = new ItemStack[5];
	private String customName;
	private int transferCooldown = -1;
	private static final String __OBFID = "CL_00000359";
	private EnumFacing outputFace=EnumFacing.DOWN;
	private EnumFacing inputFace=EnumFacing.UP;

	public AbstractTileDuct() {	
	}
	public void readFromNBT(NBTTagCompound compound) {
		...
		inputFace=EnumFacing.getFront(compound.getInteger("InputFace"));
		outputFace=EnumFacing.getFront(compound.getInteger("OutputFace"));
	}
	...
	public void writeToNBT(NBTTagCompound compound) {
		...
		compound.setInteger("InputFace", inputFace.ordinal());
		compound.setInteger("OutputFace", outputFace.ordinal());
	}
	...
	public boolean func_145887_i() {
		if (this.worldObj != null && !this.worldObj.isRemote) {
			if (!this.isOnTransferCooldown() && AbstractBlockDuct.isEnabled(this.getBlockMetadata())) {
				boolean flag = false;
	...
	private boolean func_145883_k() {
		...
		if (iinventory == null) {
			...
			EnumFacing enumfacing = AbstractBlockDuct.getFacing(this.getBlockMetadata()).getOpposite();
	...
	private static boolean func_174920_a(IInventory p_174920_0_, ItemStack p_174920_1_, int p_174920_2_, EnumFacing p_174920_3_) {
		return !p_174920_0_.isItemValidForSlot(p_174920_2_, p_174920_1_) ? false : !(p_174920_0_ instanceof ISidedInventory)
	...
	private IInventory func_145895_l() {
		EnumFacing enumfacing = AbstractBlockDuct.getFacing(this.getBlockMetadata());
		return func_145893_b(this.getWorld(), (double) (this.pos.getX() + enumfacing.getFrontOffsetX()), (double) (this.pos.getY() + enumfacing.getFrontOffsetY()),
	...
	public static EntityItem func_145897_a(World worldIn, double p_145897_1_, double p_145897_3_, double p_145897_5_) {
		List list = worldIn.getEntitiesWithinAABB(EntityItem.class, new AxisAlignedBB(p_145897_1_, p_145897_3_, p_145897_5_, p_145897_1_ + 1.0D, p_145897_3_ + 1.0D,
	...
	public static IInventory func_145893_b(World worldIn, double p_145893_1_, double p_145893_3_, double p_145893_5_) {
		...
		if (object == null) {
			List list = worldIn.getEntitiesInAABBexcluding((Entity) null, new AxisAlignedBB(p_145893_1_, p_145893_3_, p_145893_5_, p_145893_1_ + 1.0D, p_145893_3_ + 1.0D,
					p_145893_5_ + 1.0D), IEntitySelector.selectInventories);
	...
	private static boolean canCombine(ItemStack stack1, ItemStack stack2) {
		return stack1.getItem() != stack2.getItem() ? false : (stack1.getMetadata() != stack2.getMetadata() ? false : (stack1.stackSize > stack1.getMaxStackSize() ? false
	...
	public void setInputFace(EnumFacing inputFace) {
