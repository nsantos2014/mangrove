...
public class ContainerStorageJunction extends MGContainer {
	private TileStorageJunction tile;
	private Point[] invPositions;
	public int start;
	public int size;
	private int slotOffset;
	
	public ContainerStorageJunction(TileStorageJunction tile, InventoryPlayer inventory) {
