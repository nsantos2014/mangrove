...
import net.minecraft.mangrove.core.core.entity.AbstractInventoryEntity;
import net.minecraft.mangrove.core.core.inventory.InvUtils;
import net.minecraft.mangrove.core.core.inventory.InventorySupport;
import net.minecraft.mangrove.core.core.inventory.Permission;
...
public class CopyOfEntityMAV extends AbstractInventoryEntity{
private final Random field_149933_a = new Random();
    ...
    public CopyOfEntityMAV(World par1World) {
        super(par1World);
    ...
    public CopyOfEntityMAV(World par1World, double par2, double par4, double par6){
        this(par1World);
            ...
            if (!this.worldObj.isRemote) {
                ...
                if (list != null && !list.isEmpty()){
                    for (int k1 = 0; k1 < list.size(); ++k1){
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof CopyOfEntityMAV){
