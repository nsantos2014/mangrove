...
public abstract class MGGui extends GuiContainer {

	public static final ResourceLocation LEDGER_TEXTURE = new ResourceLocation("textures/gui/container/ledger.png");
	public final LedgerManager ledgerManager = new LedgerManager(this);
	public final TileEntity tile;
	public final ResourceLocation texture;
	public final MGContainer container;

	public MGGui(MGContainer container, IInventory inventory, ResourceLocation texture) {
		super(container);
	...
	protected class LedgerManager {
		...
		public LedgerManager(MGGui gui) {
			this.gui = gui;
		}
