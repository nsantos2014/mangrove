...
public abstract class GuiAdvancedInterface extends MGGui {
	...
	public GuiAdvancedInterface(MGContainer container, IInventory inventory, ResourceLocation texture) {
