...
public class GUIHandler implements IGuiHandler {
	...
	private MGContainer createContainer(EntityPlayer player, final TileEntity tile,	final Class<? extends MGContainer> clazz) {
		try {
	...
	private MGGui createGui(EntityPlayer player, final TileEntity tile,	final Class<? extends MGGui> clazz) {
		try {
