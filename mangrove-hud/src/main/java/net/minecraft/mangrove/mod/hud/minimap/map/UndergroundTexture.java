...
import net.minecraft.mangrove.mod.hud.minimap.Texture;
import net.minecraft.mangrove.mod.hud.minimap.region.ChunkRender;
import net.minecraft.mangrove.mod.hud.minimap.region.IChunk;
