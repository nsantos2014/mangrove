...
public class MapRenderer {
	...
	private ResourceLocation backgroundTexture = new ResourceLocation(MGHudForge.ID, "textures/map/background.png");
	private ResourceLocation roundMapTexture = new ResourceLocation(MGHudForge.ID, "textures/map/border_round.png");
	private ResourceLocation squareMapTexture = new ResourceLocation(MGHudForge.ID, "textures/map/border_square.png");
	private ResourceLocation playerArrowTexture = new ResourceLocation(MGHudForge.ID, "textures/map/arrow_player.png");
	private ResourceLocation northArrowTexture = new ResourceLocation(MGHudForge.ID, "textures/map/arrow_north.png");
