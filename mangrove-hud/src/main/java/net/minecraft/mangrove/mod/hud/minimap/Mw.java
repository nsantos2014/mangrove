...
import net.minecraft.mangrove.mod.hud.minimap.forge.MwConfig;
import net.minecraft.mangrove.mod.hud.minimap.forge.MwKeyHandler;
import net.minecraft.mangrove.mod.hud.minimap.gui.MwGui;
import net.minecraft.mangrove.mod.hud.minimap.gui.MwGuiMarkerDialog;
import net.minecraft.mangrove.mod.hud.minimap.map.MapTexture;
import net.minecraft.mangrove.mod.hud.minimap.map.MapView;
import net.minecraft.mangrove.mod.hud.minimap.map.Marker;
import net.minecraft.mangrove.mod.hud.minimap.map.MarkerManager;
import net.minecraft.mangrove.mod.hud.minimap.map.MiniMap;
import net.minecraft.mangrove.mod.hud.minimap.map.Trail;
import net.minecraft.mangrove.mod.hud.minimap.map.UndergroundTexture;
import net.minecraft.mangrove.mod.hud.minimap.mobs.MobMarker;
...
import net.minecraft.mangrove.mod.hud.minimap.tasks.CloseRegionManagerTask;
...
public class Mw {
	...
	public Mw(MwConfig config) {
		...
		RegionManager.logger = MGHudForge.logger;
