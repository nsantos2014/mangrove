...
public class MwUtil {
	...
	public static void logInfo(String s, Object...args) {
		MGHudForge.logger.info(String.format(s, args));
	}
	
	public static void logWarning(String s, Object...args) {
		MGHudForge.logger.warn(String.format(s, args));
	}
	
	public static void logError(String s, Object...args) {
		MGHudForge.logger.error(String.format(s, args));
	}
	
	public static void debug(String s, Object...args) {
		MGHudForge.logger.debug(String.format(s, args));
	}
