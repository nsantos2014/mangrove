...
import net.minecraft.mangrove.mod.hud.minimap.MwUtil;
...
import net.minecraft.mangrove.mod.hud.minimap.map.MapRenderer;
import net.minecraft.mangrove.mod.hud.minimap.map.MapView;
import net.minecraft.mangrove.mod.hud.minimap.map.Marker;
import net.minecraft.mangrove.mod.hud.minimap.map.mapmode.FullScreenMapMode;
import net.minecraft.mangrove.mod.hud.minimap.map.mapmode.MapMode;
import net.minecraft.mangrove.mod.hud.minimap.tasks.MergeTask;
import net.minecraft.mangrove.mod.hud.minimap.tasks.RebuildRegionsTask;
...
public class MwGui extends GuiScreen {
    ...
    public int getHeightAtBlockPos(int bX, int bZ) {
    	...
    	if ((worldDimension == this.mapView.getDimension()) && (worldDimension != -1)) {
    		bY = this.mw.mc.theWorld.getChunkFromBlockCoords(new BlockPos(bX, 0,bZ)).getHeightValue(bX & 0xf, bZ & 0xf);
    	}
    	return bY;
    }
