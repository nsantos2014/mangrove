...
//    private static final ResourceLocation craftingTableGuiTextures2 = new ResourceLocation("textures/gui/container/driller.png");
	...
	private ContainerCrate container;

    private GuiCrate(ContainerCrate container, TileEntityCrate autobench){
...
//    }
    public GuiCrate(InventoryPlayer par1InventoryPlayer, TileEntityCrate autobench){
    	this(new ContainerCrate(autobench,par1InventoryPlayer),autobench);
    }
    @Override
    public void initGui() {
    	super.initGui();
