package net.minecraft.mangrove.mod.maps.map;
...
import net.minecraft.mangrove.mod.maps.forge.MwForge;
...
public class MapRenderer {
	...
	private ResourceLocation backgroundTexture = new ResourceLocation(MwForge.DOMAIN, "textures/map/background.png");
	private ResourceLocation roundMapTexture = new ResourceLocation(MwForge.DOMAIN, "textures/map/border_round.png");
	private ResourceLocation squareMapTexture = new ResourceLocation(MwForge.DOMAIN, "textures/map/border_square.png");
	private ResourceLocation playerArrowTexture = new ResourceLocation(MwForge.DOMAIN, "textures/map/arrow_player.png");
	private ResourceLocation northArrowTexture = new ResourceLocation(MwForge.DOMAIN, "textures/map/arrow_north.png");
